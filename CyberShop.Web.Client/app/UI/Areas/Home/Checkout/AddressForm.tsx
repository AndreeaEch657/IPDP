...
interface AddressFormProps {
    ...
    handleAddress2Change: (address2: string) => void;
...
export const AddressForm: React.FunctionComponent<AddressFormProps> = (props) =>{
    return (
        <React.Fragment>
            ...
            <Grid container spacing={3}>
                <Grid item xs={12} sm={6}>
                    <TextField
                        ...
                        onChange={(e) => props.handleFirstNameChange(e.target.value)}
                    />
                </Grid>
                <Grid item xs={12} sm={6}>
                    <TextField
                ...
                <Grid item xs={12}>
                    <TextField
                        ...
                        onChange={(e) => props.handleAddress2Change(e.target.value)}
                    />
                </Grid>
                <Grid item xs={12} sm={6}>
                    <TextField
